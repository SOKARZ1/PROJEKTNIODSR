...
class CameraSimulator(Node):
    def __init__(self):
        ...
        # Publikujemy obraz na temat '/image_raw' (tak jak prawdziwa kamera)
    ...
    def timer_callback(self):
        # Tworzymy pusty obraz (czarne tło)
        img = np.zeros((480, 640, 3), np.uint8)
        
        # Rysujemy linię podziału
        cv2.line(img, (0, 240), (640, 240), (0, 255, 255), 2)
        
        # Dodajemy napisy pomocnicze
